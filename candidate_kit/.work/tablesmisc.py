...
for name in ("INV-21","INV-34","INV-12","INV-25","INV-33","INV-47","INV-48"):
    for i in (1,2,3):
        ...
        for r in sorted(t.rows)[:6]:
            print("   r",r,"DESCR=",repr(t.cell(r,-1))[:52], "|", " | ".join(f"c{c.index}={t.cell(r,c.index)!r}" for c in t.columns if t.cell(r,c.index)))
